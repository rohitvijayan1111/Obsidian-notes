...
- the company assumes that each share is worth Rs.10, and because there is Rs.5 crore as share capital, there have to be 50 lakh shares, with each share worth Rs.10. In this context, Rs.10 is called the ‘Face value’ (FV) of the share.
...
# IPO
1. As an investor in the IPO, you should read through the DRHP to know everything about the company.
...
While the Sensex and Nifty represent the broader markets, certain indices represent specific sectors.
